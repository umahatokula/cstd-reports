    ...
    <form method="POST">
      ...
      <fieldset>
            ...
            <table class="table">
              <thead>
                <tr>
                  ...
                  <th class="text-center">
                    <button @click.prevent="addDivisionTarget" class="btn btn-xs btn-primary">
                      <small>add</small>
                    </button>
                  </th>
                </tr>
              ...
              <tbody>
                <tr v-for="(target, index)  in divisionTargets" :key="target.id">
                  <td scope="row">
                    <input v-model="divisionTargets[index].target" class="form-control">
                  </td>
        ...
        <div class="form-group row">
          ...
          <small v-if="errors.appraiseeTargets" class="text-danger">{{ errors.appraiseeTargets[0] }}</small>
          <div class="col-sm-12">
            <table class="table">
              <thead>
                <tr>
                  <th>Target</th>
                  <th class="text-center">
                    <button @click.prevent="addAppraiseeTarget" class="btn btn-xs btn-primary">
                      <small>add</small>
                    </button>
                  </th>
                </tr>
              ...
              <tbody>
                <tr v-for="(target, index)  in appraiseeTargets" :key="target.id">
                  <td scope="row">
                    <input v-model="appraiseeTargets[index].target" class="form-control">
                  </td>
                  <td class="text-center">
                    <button
            ...
            <table class="table">
              <thead>
                <tr>
                  ...
                  <th class="text-center">
                    <button @click.prevent="addAchievedTarget" class="btn btn-xs btn-primary">
                      <small>add</small>
                    </button>
                  </th>
                </tr>
              ...
              <tbody>
                <tr v-for="(target, index)  in achievedTargets" :key="target.id">
                  <td scope="row">
                    <input v-model="achievedTargets[index].target" class="form-control">
                  </td>
                  <td class="text-center">
                    <button
            ...
            <table class="table">
              <thead>
                <tr>
                  ...
                  <th class="text-center">
                    <button @click.prevent="addUnachievedTarget" class="btn btn-xs btn-primary">
                      <small>add</small>
                    </button>
                  </th>
                </tr>
              ...
              <tbody>
                <tr v-for="(target, index)  in unachievedTargets" :key="target.id">
                  <td scope="row">
                    <input v-model="unachievedTargets[index].target" class="form-control">
                  </td>
                  <td class="text-center">
                    <button
      ...
      <div class="form-group row">
        <div class="col-sm-10 text-center">
          <button @click.prevent="submitForm" type="submit" class="btn btn-primary">Submit Report</button>
        </div>
      </div>
    </form>
  </div>
...
<script>
export default {
  name: "CreateMonthlyPerformanceReport",
  props: {
    user: {
      required: true
      // type: Object
